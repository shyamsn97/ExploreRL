...
class QLearningTorch(BaseTorchAgent):
    def __init__(self,estimator=None,epsilon=1.0, decay= 0.98, gamma=1.0, 
                 learning_rate=0.01, featurizer=None,scaler=None):
        super(QLearningTorch, self).__init__(estimator,gamma, 
                 learning_rate,featurizer,scaler,configs={},replay_size=0)
        self.name = "QLearningTorch"
        self.epsilon = epsilon
        self.decay = decay        
        
    def initialize_model(self,observation_space,action_space):
        super(QLearningTorch, self).initialize_model(observation_space,action_space) 
